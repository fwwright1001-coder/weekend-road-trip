...
export function preloadActors() {
  ...
  // DEPLOY NOTE: the vendored Soldier.glb rig is intentionally omitted from this
  // build — it keeps the deploy lean, avoids a 404, and procedural pedestrians suit
  // the gangster-player look better than armoured-soldier clones. Skip straight to
  // the procedural fallback (callers already handle a false result).
  _failed = true;
